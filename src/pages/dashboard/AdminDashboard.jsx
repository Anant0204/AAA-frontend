...
export const AdminDashboard = () => {
  ...
  const statsList = [
    ...
    { title: 'Completed Meetings', value: completedMeetingsCount, icon: <CheckCircleOutlinedIcon />, color: '#10B981', trend: '15%', onClick: () => navigate('/admin/consultations', { state: { filterStatus: 'Completed', cardInfo: { title: 'Completed Meetings', value: completedMeetingsCount, color: '#10B981', trend: '15%', iconType: 'CheckCircleOutlined' } } }) },
