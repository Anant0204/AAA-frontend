...
export const AdminDashboard = () => {
  ...
  const statsList = [
    ...
    { title: 'Upcoming Meetings', value: upcomingMeetingsCount, icon: <CalendarMonthIcon />, color: '#2563EB', trend: '8%', onClick: () => navigate('/admin/consultations', { state: { filterStatus: 'Scheduled', startDate: '', endDate: '', cardInfo: { title: 'Upcoming Meetings', value: upcomingMeetingsCount, color: '#2563EB', trend: '8%', iconType: 'CalendarMonth' } } }) },
    { title: 'Completed Meetings', value: completedMeetingsCount, icon: <CheckCircleOutlinedIcon />, color: '#10B981', trend: '15%', onClick: () => navigate('/admin/consultations', { state: { filterStatus: 'Completed', startDate: '', endDate: '', cardInfo: { title: 'Completed Meetings', value: completedMeetingsCount, color: '#10B981', trend: '15%', iconType: 'CheckCircleOutlined' } } }) },
    ...
    { title: 'Refunded (Guarantee Claims)', value: `€${refundedTotal.toLocaleString()}`, icon: <CancelIcon />, color: '#EF4444', trend: '4%', onClick: () => navigate('/payments/invoices', { state: { cardInfo: { title: 'Refunded (Guarantee Claims)', value: `€${refundedTotal.toLocaleString()}`, color: '#EF4444', trend: '4%', iconType: 'Cancel' } } }) },
  ];
