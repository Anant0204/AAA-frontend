...
export const AgentDashboard = () => {
  ...
  const completedConsultations = myConsultations.filter(
    (c) => c.status === 'Completed' || c.status === 'Meeting Completed'
  ).length;
  ...
  const statsList = [
    ...
    { title: 'Completed Meetings', value: completedConsultations, icon: <CheckCircleOutlinedIcon />, color: '#10B981', onClick: () => navigate('/agent/consultations', { state: { filterStatus: 'Completed', cardInfo: { title: 'Completed Meetings', value: completedConsultations, color: '#10B981', iconType: 'CheckCircleOutlined' } } }) },
