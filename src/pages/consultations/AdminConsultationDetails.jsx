      ...
      <PageHeader
        ...
        action={
          <Stack direction="row" spacing={1}>
            ...
            {(cons.status === 'Scheduled' || cons.status === 'Unblocked') && cons.assignedConsultantId && (cons.assignedConsultantId === currentUser?.id || currentUser?.role === 'admin' || currentUser?.role === 'super_admin') && (
              <>
                <Button
                  variant="contained"
                  color="success"
