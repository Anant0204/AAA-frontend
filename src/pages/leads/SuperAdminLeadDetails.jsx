                            ...
                            {lead.qualificationData ? (
                              Object.entries(lead.qualificationData)
                                ...
                                .map(([key, value]) => {
                                  ...
                                  if (value && (key === 'paidAt' || key === 'uploadedAt' || key === 'createdAt' || key.toLowerCase().includes('at') || key.toLowerCase().includes('date') || (typeof value === 'string' && value.includes('T') && value.includes('Z')))) {
