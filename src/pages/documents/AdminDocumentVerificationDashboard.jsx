        ...
        <Box sx={{ pb: 4 }}>
          ...
          {!selectedClient ? (
            ...
            <Box className="grid grid-cols-12 gap-7">
              {/* TOP FULL-WIDTH COLUMN: PDF Intake Form Mockup */}
              ...
              >
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2, pb: 1.5, borderBottom: '1px solid #F1F5F9' }}>
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, flexWrap: 'wrap' }}>
                    ...
                    <Chip
                      label={isTranslationClient ? '📜 Spanish Sworn Translation' : `✈️ ${SERVICES.find(s => s.id === selectedClient.serviceId)?.name || 'Visa Package'}`}
                ...
                <Box className="grid grid-cols-12 gap-4">
                  ...
                  <Box className="col-span-12 sm:col-span-4">
                    ...
                    <Typography variant="body2" sx={{ fontWeight: 800, color: '#0F172A', fontSize: '0.85rem' }}>
                      {selectedClient.dateOfBirth ? new Date(selectedClient.dateOfBirth).toLocaleDateString('en-GB') : 'N/A'} ({selectedClient.nationality?.toUpperCase() || 'N/A'})
                    </Typography>
                  </Box>
            ...
            {isTranslationClient && (
              <Box className="col-span-12" sx={{ mb: 2 }}>
                ...
                >
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 2, flexWrap: 'wrap' }}>
                    <input
                      type="file"
                      id="staff-sworn-drag-input-admin"
                      style={{ display: 'none' }}
                    ...
                    <Button
                      ...
                      onClick={() => document.getElementById('staff-sworn-drag-input-admin').click()}
              ...
              {/* BOTTOM FULL-WIDTH COLUMN: Real Client Uploaded File Checklist */}
              <Box className="col-span-12" sx={{ mt: 3 }}>
                <Typography variant="h6" sx={{ fontWeight: 800, mb: 2, display: 'flex', alignItems: 'center', gap: 1 }}>
                  <InsertDriveFileIcon color="primary" /> Uploaded Document Checklist
                </Typography>
                            ...
                            <Button
                              ...
                              onClick={() =>
                                reviewDocumentMutation.mutate({
                                  documentId: doc.id,
                                  status: 'Verified',
                                  comment: 'Document verified and approved by admin.'
                                })
                              }
                              sx={{ textTransform: 'none', fontSize: '0.62rem', fontWeight: 700, minWidth: 0, flex: 1, px: 0.4, py: 0.3 }}
                            >
